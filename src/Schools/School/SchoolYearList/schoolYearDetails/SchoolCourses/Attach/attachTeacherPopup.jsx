...
const AttachTeacherPopup = ({labelTransition, closeModal, selection, selected, title, data}) => {
    ...
    const Search=()=>{
        ...
        if(keyword !== undefined && keyword !== ""){
            ...
            let url='http://127.0.0.1:8000/api/searchSchoolTeacher';
            ...
            <div className="popup" ref={nodeRef}>
                ...
                <div className="label-main">
                    ...
                    <div className="label-results">
                        ...
                        {errors.length ?
                            <div className="label-result label-missing flex attachError" >
                                <h4>Teacher is not found</h4>
...
export default AttachTeacherPopup;